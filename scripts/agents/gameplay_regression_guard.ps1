...
Invoke-GuardScript -RelativePath "scripts\check_fiber_cable_lead_angle.ps1" -ScriptArgs @("-Root", $Root)
...
Invoke-GuardScript -RelativePath "scripts\check_ground_slide_feedback.ps1" -ScriptArgs @("-Root", $Root)
