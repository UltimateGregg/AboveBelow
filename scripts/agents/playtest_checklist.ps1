...
if (Include-Area "UI") {
    ...
    Add-Line $lines "- [ ] `Play` opens a team picker with a Back button."
    Add-Line $lines "- [ ] Selecting Drone Pilots or Soldiers opens only that side's loadout/class picker with a Back button."
