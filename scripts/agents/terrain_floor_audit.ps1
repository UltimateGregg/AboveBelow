        ...
        try {
            ...
            if ($heightBytes.Length -eq ($expectedPixels * 2) -and $controlBytes.Length -eq ($expectedPixels * 4)) {
                ...
                $protectedSamples = @(
                    ...
                    [pscustomobject]@{ Name = "Road south clear apron center"; X = 416.190948; Y = -6200 },
                    [pscustomobject]@{ Name = "Road south clear apron west edge"; X = 56.190948; Y = -6200 },
                    [pscustomobject]@{ Name = "Road south clear apron east edge"; X = 776.190948; Y = -6200 },
                    [pscustomobject]@{ Name = "Road south outer apron center"; X = 416.190948; Y = -6500 },
                    [pscustomobject]@{ Name = "Road south outer apron west edge"; X = 56.190948; Y = -6500 },
                    [pscustomobject]@{ Name = "Road south outer apron east edge"; X = 776.190948; Y = -6500 },
                    ...
                    [pscustomobject]@{ Name = "Road north clear apron center"; X = 416.190948; Y = 6200 },
                    [pscustomobject]@{ Name = "Road north clear apron west edge"; X = 56.190948; Y = 6200 },
                    [pscustomobject]@{ Name = "Road north clear apron east edge"; X = 776.190948; Y = 6200 },
                    [pscustomobject]@{ Name = "Road north outer apron center"; X = 416.190948; Y = 6500 },
                    [pscustomobject]@{ Name = "Road north outer apron west edge"; X = 56.190948; Y = 6500 },
                    [pscustomobject]@{ Name = "Road north outer apron east edge"; X = 776.190948; Y = 6500 },
