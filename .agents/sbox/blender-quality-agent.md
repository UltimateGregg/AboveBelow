...
- For high-polish assets, check the generated asset brief before modeling decisions. The source scene should be able to satisfy the profile's production quality targets and visual review checks, not just pass mesh-count and transform checks.
